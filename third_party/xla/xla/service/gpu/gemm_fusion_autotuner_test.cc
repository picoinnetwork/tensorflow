...
TEST_F(DynamicSliceReplacementTest,
       ReplacesDynamicSliceInFusionAndRemovesUnusedOffsets) {
  std::unique_ptr<VerifiedHloModule> module = ParseAndReturnVerifiedModule(R"(
...
ENTRY entry {
  ...
  EXPECT_OK(
      ReplaceDynamicSliceWithSliceInTheComputationOfTheRootFusion(*module));
...
TEST_F(
    DynamicSliceReplacementTest,
    Replaces2DynamicSlicesHavingSharedIndicesInFusionAndRemovesUnusedOffsets) {
...
TEST_F(DynamicSliceReplacementTest,
       ReplacesDynamicSliceInEntryComputationAndRemovesUnusedOffsets) {
  std::unique_ptr<VerifiedHloModule> module = ParseAndReturnVerifiedModule(R"(
HloModule module, entry_computation_layout={
            (f32[2,4]{1,0}, f32[7,2]{1,0}, s32[], s32[])->f32[4,4]{1,0}}
